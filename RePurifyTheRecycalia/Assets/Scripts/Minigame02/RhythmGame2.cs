...
public class RhythmGame2 : MonoBehaviour
{
    public static RhythmGame2 Instance;
    ...
    public TrashNote2.TrashType2 targetTrashType = TrashNote2.TrashType2.Hazard;
    ...
    IEnumerator AutoStartAfterRules()
{
    ...
    StartGameFromRules();   // กดเริ่มให้อัตโนมัติ
}
    ...
    IEnumerator FlashBin(GameObject bin)
{
    ...
    {
        TrashNote2[] notes = FindObjectsOfType<TrashNote2>();
